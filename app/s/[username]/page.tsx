...
export default function ChatterPage({ params }: { params: Promise<{ username: string }> }) {
  ...
  async function sendVoice() {
    ...
    form.append('streamer', username)
    form.append('chatter_username', 'Chatter')
    ...
    <main className="min-h-screen bg-gray-950 text-white flex items-center justify-center p-6">
      <div className="bg-gray-900 rounded-2xl p-8 w-full max-w-md text-center">
        ...
        <p className="text-gray-400 text-sm mb-8">
          Envoie ta voix au stream de <span className="text-purple-400">@{username}</span>
        </p>
